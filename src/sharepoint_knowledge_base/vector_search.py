"""Vector search management for SP documents."""
...
class VectorSearchManager:
    ...
    def __init__(
        ...
        self.index_name = f"{self.catalog}.{self.schema}.documents_index"
    ...
    def create_or_get_index(self) -> Any:
        ...
        source_table = f"{self.catalog}.{self.schema}.document_chunks"
